...
export const PRODUCT_DATABASE: Product[] = [
  ...
  { name: 'majs', category: 'frukt-gront', aliases: ['majskolvar', 'kornmajskolvar'], popularity: 7 },
  { name: 'majskorn', category: 'frukt-gront', aliases: ['majs konserv', 'konservmajskorn'], popularity: 8 },
  { name: 'ärtor', category: 'frukt-gront', aliases: ['gröna ärtor'], popularity: 7 },
  { name: 'bönor', category: 'frukt-gront', aliases: ['gröna bönor', 'haricots verts'], popularity: 6 },
  { name: 'kidneybönor', category: 'frukt-gront', aliases: ['röda bönor'], popularity: 6 },
  { name: 'svarta bönor', category: 'frukt-gront', popularity: 5 },
  { name: 'kikärtor', category: 'frukt-gront', aliases: ['chickpeas'], popularity: 6 },
  { name: 'linser', category: 'frukt-gront', aliases: ['röda linser', 'gröna linser'], popularity: 6 },
  { name: 'selleri', category: 'frukt-gront', aliases: ['selleristjälkar'], popularity: 5 },
  { name: 'fänkål', category: 'frukt-gront', popularity: 4 },
  { name: 'palsternacka', category: 'frukt-gront', popularity: 4 },
  { name: 'rättika', category: 'frukt-gront', aliases: ['rädisor'], popularity: 5 },
  { name: 'rödbetor', category: 'frukt-gront', aliases: ['rödkål'], popularity: 5 },
  { name: 'vitkål', category: 'frukt-gront', popularity: 6 },
  { name: 'rödkål', category: 'frukt-gront', popularity: 5 },
  { name: 'kålrabbi', category: 'frukt-gront', popularity: 4 },
  { name: 'purjolök', category: 'frukt-gront', aliases: ['purjo'], popularity: 5 },
  { name: 'schalottenlök', category: 'frukt-gront', aliases: ['schalotter'], popularity: 4 },
  
  // Fler frukter 
  { name: 'melon', category: 'frukt-gront', aliases: ['honungsmelon', 'vattenmelon'], popularity: 6 },
  { name: 'persika', category: 'frukt-gront', aliases: ['persikor'], popularity: 5 },
  { name: 'plommon', category: 'frukt-gront', popularity: 5 },
  { name: 'aprikos', category: 'frukt-gront', aliases: ['aprikoser'], popularity: 4 },
  { name: 'körsbär', category: 'frukt-gront', popularity: 5 },
  { name: 'granatäpple', category: 'frukt-gront', popularity: 4 },
  { name: 'kokos', category: 'frukt-gront', aliases: ['kokosnöt'], popularity: 4 },
  { name: 'dadlar', category: 'frukt-gront', popularity: 4 },
  { name: 'fikon', category: 'frukt-gront', popularity: 3 },
  
  // Kryddor & örter
  { name: 'oregano', category: 'frukt-gront', popularity: 5 },
  { name: 'timjan', category: 'frukt-gront', popularity: 4 },
  { name: 'rosmarin', category: 'frukt-gront', popularity: 4 },
  { name: 'salvia', category: 'frukt-gront', popularity: 3 },
  { name: 'mynta', category: 'frukt-gront', popularity: 4 },
  { name: 'koriander', category: 'frukt-gront', popularity: 5 },
  { name: 'gräslök', category: 'frukt-gront', popularity: 6 },
